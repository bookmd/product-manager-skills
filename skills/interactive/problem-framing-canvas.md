...
1. **Validate with users:** Use `discovery-interview-prep.md` to test reframed problem with customers
2. **Generate solutions:** Use `opportunity-solution-tree.md` to explore solution space
3. **Create problem statement:** Use `problem-statement.md` to formalize for PRD/roadmap
...
### Related Skills
- `problem-statement.md` — Converts reframed problem into formal problem statement
- `opportunity-solution-tree.md` — Uses HMW statement to generate solution options
- `discovery-interview-prep.md` — Validates reframed problem with customers
...
**Dependencies:** Uses `problem-statement.md`
