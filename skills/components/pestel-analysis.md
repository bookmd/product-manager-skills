...
### Related Skills
- `recommendation-canvas.md` — PESTEL factors inform risk assessment in canvas
- `positioning-statement.md` — PESTEL insights shape competitive positioning
- `problem-statement.md` — Social/economic factors influence customer problems
...
**Dependencies:** References `recommendation-canvas.md`, `positioning-statement.md`
