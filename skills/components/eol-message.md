...
Use positioning statement format (reference `positioning-statement.md`):
...
### Related Skills
- `positioning-statement.md` — Informs the transition solution positioning
- `problem-statement.md` — Helps frame the customer impact section
- `proto-persona.md` — Defines affected customers
...
**Dependencies:** References `positioning-statement.md`, `problem-statement.md`, `proto-persona.md`
