...
### Related Skills
- `positioning-statement.md` — Use company research to understand competitive positioning
- `pestel-analysis.md` — Company research informs market context
- `proto-persona.md` — Executive quotes may reveal target personas
...
**Dependencies:** References `positioning-statement.md`, `pestel-analysis.md`
